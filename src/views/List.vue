<template>
    ...
    >
        <template #append>
            <el-button @click="getData()"><el-icon style="vertical-align: middle">
                <Search />
            </el-icon></el-button>
        </template>
    </el-input>
    <el-button type="primary" @click="dialogVisible = true;handleClick($event)" style="margin-left: 20px;width:60px;height:30px;">
        新增
    </el-button>
    ...
    >
      ...
      <span class="dialog-footer">
        <el-button @click="dialogVisible = false;this.$refs.formData.resetFields();">取消</el-button>
